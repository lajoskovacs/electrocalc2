...
# version 0.2  2024.02.17.- 2024.02.25.   KL
import flet as ft
from math import pi
...
def main(page: ft.Page):
 ...
 ###########################################################################################
      ...
      ###########################################################################################
       ...
       ###########################################################################################
        ...
        tb_xl_L = ft.TextButton(
                content= ft.Text(value="Induktivitás,L (mH)",size=BUTTS, width=BUTTW),
                style= buttstyle1, 
                on_click=xl_L_click
        )
        tb_xl_XL = ft.TextButton(
                content= ft.Text(value="XL (ohm)",size=BUTTS, width=BUTTW),
                style= buttstyle1,
                on_click=xl_XL_click
        )
        tf_xl_f = ft.TextField(value=" ", width = TEXTW)
        tf_xl_L = ft.TextField(value=" ", width = TEXTW)
        tf_xl_XL = ft.TextField(value=" ", width = TEXTW)
       ...
       ###########################################################################################
        ...
        tb_xc_C = ft.TextButton(
                content= ft.Text(value="Kapacitás, C (nF)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=xc_C_click
        )
        tb_xc_XC = ft.TextButton(
                content= ft.Text(value="   XC   (ohm)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=xc_XC_click
        )
        tf_xc_f = ft.TextField(value=" ", width = TEXTW)
        tf_xc_C = ft.TextField(value=" ", width = TEXTW)
        tf_xc_XC = ft.TextField(value=" ", width = TEXTW)
       ...
       ###########################################################################################
        ...
        tb_fo_f = ft.TextButton(
                content= ft.Text(value="Rezonancia frekvencia, fo (Hz)",size=BUTTS, width=BUTTW), 
                style= buttstyle1,  
                on_click=fo_f_click
        )
        ...
        tf_fo_f = ft.TextField(value=" ", width = TEXTW)
        tf_fo_L = ft.TextField(value=" ", width = TEXTW)
        tf_fo_C = ft.TextField(value=" ", width = TEXTW)
       ...
       ###########################################################################################
        ...
        tb_rlc_R = ft.TextButton(
                content= ft.Text(value="Ellenállás, R (ohm)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
             #  on_click=rlc_R_click
        )
        tb_rlc_Ze = ft.TextButton(
                content= ft.Text(value="Impedancia, Ze (ohm)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=rlc_Ze_click
        )
        tb_rlc_fi = ft.TextButton(
                content= ft.Text(value="Fázisszög, fi (fok)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=rlc_Ze_click
        )

        tf_rlc_f = ft.TextField(value=" ", width = TEXTW)
        tf_rlc_L = ft.TextField(value=" ", width = TEXTW)
        tf_rlc_C = ft.TextField(value=" ", width = TEXTW)
        tf_rlc_R = ft.TextField(value=" ", width = TEXTW)
        tf_rlc_Ze = ft.TextField(value=" ", width = TEXTW)
        tf_rlc_fi = ft.TextField(value=" ", width = TEXTW)
      ...
      ###########################################################################################
        ...
        tb_r_l = ft.TextButton(
                content= ft.Text(value="Hossz, l (m)",size=BUTTS, width=BUTTW), 
                style= buttstyle1,
        )
        tb_r_d = ft.TextButton(
                content= ft.Text(value="Átmérő, d (mm)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
        )
        ...
        tf_r_l = ft.TextField(value=" ", width = TEXTW)
  ...
  ###########################################################################################
        ...
        tb_rc_Tr = ft.TextButton(
                content= ft.Text(value="Feszültség átvitel, Uki / Ube",size=BUTTS, width=BUTTW),
                style= buttstyle1,  
                on_click=rc_Tr_click
        )
    
        tb_rc_fi = ft.TextButton(
                content= ft.Text(value="Fázistolás, ki-be (fok)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=rc_Tr_click
        )
        tb_rc_fh = ft.TextButton(
                content= ft.Text(value="Határfrekvencia, fh (Hz)",size=BUTTS, width=BUTTW), 
                style= buttstyle1, 
                on_click=rc_Tr_click
        )

        tf_rc_f = ft.TextField(value=" ", width = TEXTW)  
        tf_rc_C = ft.TextField(value=" ", width = TEXTW)
        tf_rc_R = ft.TextField(value=" ", width = TEXTW)
        tf_rc_Tr = ft.TextField(value=" ", width = TEXTW)
        tf_rc_fi = ft.TextField(value=" ", width = TEXTW)
        tf_rc_fh = ft.TextField(value=" ", width = TEXTW)
 ...
 ###########################################################################################
        ...
        tf_cr_f = ft.TextField(value=" ", width = TEXTW)  
        tf_cr_C = ft.TextField(value=" ", width = TEXTW)
        tf_cr_R = ft.TextField(value=" ", width = TEXTW)
        tf_cr_Tr = ft.TextField(value=" ", width = TEXTW)
        tf_cr_fi = ft.TextField(value=" ", width = TEXTW)
        tf_cr_fh = ft.TextField(value=" ", width = TEXTW)
